...
public final class ActivityViewBinding implements ViewBinding {
  ...
  private ActivityViewBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView,
  ...
  public static ActivityViewBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityViewBinding((ConstraintLayout) rootView, textView, viewpager);
    }
